...
var quasisplice63 = function (x, depth) {
  return can_unquote63(depth) && hd(x) === "unquote-splicing";
};
...
accessor63 = function (x) {
  return string63(x) && _35(x) > 1 && code(x, 0) === 46 && !( code(x, 1) === 46) || hd(x) === "%brackets";
};
  ...
  if (accessor63(__a1)) {
    ...
    if (accessor63(hd(__a1))) {
      ...
      while (__i15 < _35(args)) {
        ...
        if (accessor63(__x84) || accessor63(hd(__x84))) {
...
var parenthesize_call63 = function (x) {
  return hd(x) === "%function" || precedence(x) > 0;
};
var compile_call = function (form) {
  ...
  if (__args3) {
    ...
    __e26 = compile_atom(__f);
  }
  var __f1 = __e26;
  var __e27;
  if (__args3) {
    __e27 = compile_args(stash42(__args3));
  } else {
    __e27 = "";
  }
  var __args12 = __e27;
...
var compile_infix = function (form) {
  ...
  var __a2 = ____id111[0];
  var __b2 = ____id111[1];
  var ____id12 = op_delims(form, __a2);
  var __ao = ____id12[0];
  var __ac = ____id12[1];
...
var standalone63 = function (form) {
  return ! atom63(form) && ! infix63(hd(form)) && ! literal63(form) && !( "get" === hd(form)) && !( two63(form) && accessor63(form[1])) || id_literal63(form);
};
...
var lower_short = function (x, args, hoist) {
  ...
  if (some63(__hoist1)) {
    ...
    return lower(["do", ["%local", __id20, __a4], __e41], hoist);
  } else {
...
setenv("%try", {_stash: true, special: function (form) {
  ...
  indent_level = indent_level - 1;
  var __body11 = ____x140;
  var __hf = ["return", ["%array", false, __e6]];
  indent_level = indent_level + 1;
  var ____x143 = compile(__hf, {_stash: true, stmt: true});
  indent_level = indent_level - 1;
  var __h = ____x143;
  return __ind5 + "try {\n" + __body11 + __ind5 + "}\n" + __ind5 + "catch (" + __e6 + ") {\n" + __h + __ind5 + "}\n";
}, stmt: true, tr: true});
...
setenv("%local-function", {_stash: true, special: function (name, args, body) {
  if (target === "lua") {
    var __x147 = compile_function(args, body, {_stash: true, name: name, prefix: "local"});
...
setenv("error", {_stash: true, special: function (x) {
  var __e45;
  if (target === "js") {
    __e45 = "throw " + compile(["new", ["Error", x]]);
  } else {
...
setenv("%object", {_stash: true, special: function () {
  ...
  for (__k16 in ____o10) {
    ...
    if (number63(__k17)) {
      var ____id29 = __v9;
      var __k18 = ____id29[0];
      var __v10 = ____id29[1];
      if (! string63(__k18)) {
        throw new Error("Illegal key: " + str(__k18));
      }
      __s6 = __s6 + __c7 + key(__k18) + __sep + compile(__v10);
      __c7 = ", ";
    }
  }
  return __s6 + "}";
