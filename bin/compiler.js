...
compile = function (form) {
  ...
  if (nil63(__form1)) {
    ...
    if (special_form63(__form1)) {
      ...
      var __e46;
      if (atom63(__form1)) {
        __e46 = compile_atom(__form1);
      } else {
        var __e47;
        if (infix63(hd(__form1))) {
          __e47 = compile_infix(__form1);
        } else {
          __e47 = compile_call(__form1);
        }
        __e46 = __e47;
      }
      var __form2 = __e46;
...
var lower_short = function (x, args, hoist) {
  ...
  if (some63(__hoist1)) {
    ...
    var __e53;
    if (x === "and") {
      __e53 = ["%if", __id21, __b5, __id21];
    } else {
      __e53 = ["%if", __id21, __id21, __b5];
    }
    return lower(["do", ["%local", __id21, __a4], __e53], hoist);
  } else {
...
var lower_while = function (args, hoist) {
  ...
  var __e54;
  if (none63(__pre)) {
    __e54 = ["%while", __c5, lower_body(__body6)];
  } else {
    __e54 = ["%while", true, join(["do"], __pre, [["%if", ["not", __c5], ["break"]], lower_body(__body6)])];
  }
...
setenv("do", {_stash: true, special: function () {
  ...
  var __s3 = "";
  var ____x145 = __forms1;
  var ____i19 = 0;
  while (____i19 < _35(____x145)) {
    var __x146 = ____x145[____i19];
    if (target === "lua" && immediate_call63(__x146) && "\n" === char(__s3, edge(__s3))) {
      __s3 = clip(__s3, 0, edge(__s3)) + ";\n";
    }
    __s3 = __s3 + compile(__x146, {_stash: true, stmt: true});
    if (! atom63(__x146)) {
      if (hd(__x146) === "return" || hd(__x146) === "break") {
        break;
      }
    }
    ____i19 = ____i19 + 1;
...
setenv("%try", {_stash: true, special: function (form) {
  ...
  indent_level = indent_level + 1;
  var ____x161 = compile(form, {_stash: true, stmt: true});
  indent_level = indent_level - 1;
  var __body17 = ____x161;
