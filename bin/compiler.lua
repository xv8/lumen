...
function bind(lh, rh)
  if atom63(lh) then
    ...
    for __k1 in next, ____o1 do
      ...
      local __e21
      if __k1 == "rest" then
        __e21 = {"cut", __id, _35(lh)}
      else
        __e21 = {"get", __id, {"quote", bias(__k1)}}
      end
      local __x5 = __e21
      if is63(__k1) then
        local __e22
...
function expand_function(__x41)
  local ____id2 = __x41
...
function expand_definition(__x46)
  local ____id3 = __x46
...
setenv("%object", {_stash = true, special = function (...)
  ...
  while ____i23 < _35(____x179) do
    local ____id30 = ____x179[____i23 + 1]
    local __k121 = ____id30[1]
    local __v11 = ____id30[2]
    __s9 = __s9 .. __c9 .. key(compile(__k121)) .. __sep1 .. compile(__v11)
    __c9 = ", "
    ____i23 = ____i23 + 1
  end
  return __s9 .. "}"
