...
setenv("guard", {_stash: true, macro: function (expr) {
  if (target === "js") {
    ...
    var ____x286 = ["obj"];
    ____x286.stack = [["get", "debug", ["quote", "traceback"]]];
...
setenv("each", {_stash: true, macro: function (x, t) {
  ...
  var __x311 = destash33(x, ____r75);
...
setenv("step", {_stash: true, macro: function (v, t) {
  ...
  var __x343 = unique("x");
  var __i7 = unique("i");
  return ["let", [__x343, __t3], ["for", __i7, ["#", __x343], join(["let", [__v10, ["at", __x343, __i7]]], __body45)]];
}});
...
setenv("with-indent", {_stash: true, macro: function (form) {
  var __x378 = unique("x");
  return ["do", ["inc", "indent-level"], ["with", __x378, form, ["dec", "indent-level"]]];
}});
