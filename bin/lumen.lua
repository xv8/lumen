...
setenv("guard", {_stash = true, macro = function (expr)
  if target == "js" then
    ...
    local ____x310 = {"obj"}
    ____x310.stack = {{"get", "debug", {"quote", "traceback"}}}
...
setenv("each", {_stash = true, macro = function (x, t, ...)
  ...
  local __x336 = destash33(x, ____r75)
  ...
  local __i3 = unique("i")
  local __e10
  if atom63(__x336) then
    __e10 = {__i3, __x336}
  else
    local __e11
    if _35(__x336) > 1 then
      __e11 = __x336
    else
      __e11 = {__i3, hd(__x336)}
    end
    __e10 = __e11
  end
...
setenv("step", {_stash = true, macro = function (v, t, ...)
  ...
  local __x370 = unique("x")
  local __i7 = unique("i")
  return {"let", {__x370, __t3}, {"for", __i7, {"#", __x370}, join({"let", {__v10, {"at", __x370, __i7}}}, __body45)}}
end})
