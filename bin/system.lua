...
return {["read-file"] = read_file, write = write, ["file-exists?"] = file_exists63, argv = argv, ["path-join"] = path_join, run = run, ["directory-exists?"] = directory_exists63, reload = reload, exit = exit, ["write-file"] = write_file, ["path-separator"] = path_separator, ["get-environment-variable"] = get_environment_variable}
