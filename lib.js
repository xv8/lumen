var create = function (globals) {
  ...
  setenv("with-bindings", {["_stash"]: true, ["macro"]: function (__x115, ...__r101) {
    ...
    return join(["with-frame", ["each", __x116, __names, ____x119]], __body14);
  }});
  setenv("let-macro", {["_stash"]: true, ["macro"]: function (definitions, ...__r102) {
    ...
    var ____x120 = join(["do"], macroexpand(__body15));
    drop(_G.environment);
    return ____x120;
  }});
  setenv("let-symbol", {["_stash"]: true, ["macro"]: function (expansions, ...__r104) {
    ...
    var ____x123 = join(["do"], macroexpand(__body16));
    drop(_G.environment);
    return ____x123;
  }});
  ...
  setenv("each", {["_stash"]: true, ["macro"]: function (x, t, ...__r111) {
    ...
    var __x140 = destash33(x, ____r111);
  ...
  setenv("step", {["_stash"]: true, ["macro"]: function (v, t, ...__r113) {
    ...
    var __x158 = unique("x");
    var __i27 = unique("i");
    return ["let", [__x158, __t3], ["for", __i27, ["#", __x158], join(["let", [__v17, ["at", __x158, __i27]]], __body21)]];
  }});
  ...
  setenv("class", {["_stash"]: true, ["macro"]: function (x, ...__r120) {
    ...
    var __x186 = destash33(x, ____r120);
    var ____id36 = ____r120;
    var __body23 = cut(____id36, 0);
    if (atom63(__x186)) {
      return join(["%class", [__x186]], __body23);
    } else {
      return join(["%class", __x186], __body23);
    }
  }});
  setenv(".", {["_stash"]: true, ["macro"]: function (...args) {
    ...
    if (none63(__args7)) {
      ...
      if (one63(__args7)) {
        ...
        var __x193 = ____id37[1];
        var __args8 = cut(____id37, 2);
        var __e28;
        if (atom63(__x193)) {
          __e28 = ["quote", compile(__x193)];
        } else {
          var __e29;
          if ("quote" === hd(__x193)) {
            __e29 = ["quote", compile(__x193[1])];
          } else {
            __e29 = __x193;
          }
          __e28 = __e29;
        ...
        if (! atom63(__x193) && "quote" === hd(__x193) || string_literal63(__x193)) {
          return __expr1;
        } else {
    ...
    if (atom63(lh)) {
      ...
      for (__k26 in ____o17) {
        ...
        if (is63(__k27)) {
          ...
          var __k28 = __e42;
          __bs4 = join(__bs4, bind(__k28, __x203));
        }
      }
      return __bs4;
    }
  ...
  var expand_local = function (__x219) {
    var ____id39 = __x219;
    var __x220 = ____id39[0];
  ...
  var expand_function = function (__x222) {
    var ____id40 = __x222;
    var __x223 = ____id40[0];
    var __args9 = ____id40[1];
    var __body24 = cut(____id40, 2);
    add(_G.environment, {});
    var ____o19 = __args9;
    var ____i34 = undefined;
    for (____i34 in ____o19) {
      var ____x224 = ____o19[____i34];
      var __e44;
      if (numeric63(____i34)) {
        __e44 = parseInt(____i34);
      } else {
        __e44 = ____i34;
      }
      var ____i341 = __e44;
      setenv(____x224, {["_stash"]: true, ["variable"]: true});
    }
    var ____x225 = join(["%function", __args9], macroexpand(__body24));
    drop(_G.environment);
    return ____x225;
  };
  var expand_table = function (__x227) {
    var ____id41 = __x227;
    var __x228 = ____id41[0];
    var __args10 = cut(____id41, 1);
    var __expr2 = join([__x228], keys(__args10));
    var ____x230 = __args10;
    var ____i35 = 0;
    while (____i35 < _35(____x230)) {
      var __x231 = ____x230[____i35];
      if (atom63(__x231)) {
        add(__expr2, [__x231, macroexpand(__x231)]);
      } else {
        if (_35(__x231) <= 2) {
          var ____id42 = __x231;
          var __name8 = ____id42[0];
          var __v22 = ____id42[1];
          add(__expr2, [macroexpand(__name8), macroexpand(__v22)]);
        } else {
          var ____id43 = __x231;
          var __prefix = ____id43[0];
          var __name9 = ____id43[1];
          var __args111 = ____id43[2];
          var __body25 = cut(____id43, 3);
          if (some63(__body25)) {
            add(_G.environment, {});
            var ____o20 = __args111;
            var ____i36 = undefined;
            for (____i36 in ____o20) {
              var ____x234 = ____o20[____i36];
              var __e45;
              if (numeric63(____i36)) {
                __e45 = parseInt(____i36);
              } else {
                __e45 = ____i36;
              }
              var ____i361 = __e45;
            ...
            var ____x235 = add(__expr2, join([__prefix, macroexpand(__name9), __args111], macroexpand(__body25)));
            drop(_G.environment);
            ____x235;
          } else {
  ...
  var expand_class = function (__x238) {
    var ____id44 = __x238;
    var __x239 = ____id44[0];
    var __name10 = ____id44[1];
    var __body26 = cut(____id44, 2);
    return join([__x239, __name10], tl(expand_table(join(["%table"], __body26))));
  };
  var expand_definition = function (__x242) {
    var ____id45 = __x242;
    var __x243 = ____id45[0];
    var __name11 = ____id45[1];
    var __args121 = ____id45[2];
    var __body27 = cut(____id45, 3);
    add(_G.environment, {});
    ...
    var ____x245 = join([__x243, __name11, __args121], macroexpand(__body27));
    drop(_G.environment);
    return ____x245;
  };
  ...
  expand1 = function (__x247) {
    var ____id46 = __x247;
    var __name12 = ____id46[0];
    var __body28 = cut(____id46, 1);
          ...
          if (__x248 === "%function") {
            ...
            if (__x248 === "%table") {
              ...
              if (__x248 === "%class") {
                ...
                if (__x248 === "%global-function") {
                  return expand_definition(form);
                } else {
                  if (__x248 === "%local-function") {
                    return expand_definition(form);
                  } else {
                    if (macro63(__x248)) {
  ...
  var quasiquote_list = function (form, depth) {
    ...
    var ____o22 = form;
    var __k31 = undefined;
    for (__k31 in ____o22) {
      var __v23 = ____o22[__k31];
      var __e47;
      if (numeric63(__k31)) {
        __e47 = parseInt(__k31);
      } else {
        __e47 = __k31;
      }
      var __k32 = __e47;
      if (! number63(__k32)) {
        ...
        if (quasisplice63(__v23, depth)) {
          __e48 = quasiexpand(__v23[1]);
        } else {
          __e48 = quasiexpand(__v23, depth);
        }
        var __v24 = __e48;
    ...
    var ____x251 = form;
    var ____i39 = 0;
    while (____i39 < _35(____x251)) {
      var __x252 = ____x251[____i39];
      if (quasisplice63(__x252, depth)) {
        var __x253 = quasiexpand(__x252[1]);
        add(__xs13, __x253);
        add(__xs13, ["list"]);
      } else {
        add(last(__xs13), quasiexpand(__x252, depth));
      }
      ____i39 = ____i39 + 1;
    }
  ...
  unique = function (x) {
    var __x261 = id(x);
    if (__names3[__x261]) {
      var __i42 = __names3[__x261];
      __names3[__x261] = __names3[__x261] + 1;
      return unique(__x261 + __i42);
    } else {
      __names3[__x261] = 1;
      return "__" + __x261;
    }
  ...
  mapo = function (f, t) {
    ...
    var ____o24 = t;
    var __k33 = undefined;
    for (__k33 in ____o24) {
      var __v25 = ____o24[__k33];
      var __e53;
      if (numeric63(__k33)) {
  ...
  var ____x274 = [];
  ____x274.js = "&&";
  ____x273.and = ____x274;
  var ____x275 = [];
  var ____x276 = [];
  ____x276.js = "||";
  ____x275.or = ____x276;
  var infix = [____x264, ____x266, ____x267, ____x269, ____x270, ____x271, ____x273, ____x275];
  ...
  var precedence = function (form) {
    if (!( atom63(form) || unary63(form))) {
      ...
      for (__k35 in ____o25) {
        var __v26 = ____o25[__k35];
        var __e54;
        if (numeric63(__k35)) {
          __e54 = parseInt(__k35);
        } else {
          __e54 = __k35;
        }
        var __k36 = __e54;
  ...
  var compile_args = function (args) {
    ...
    var ____x279 = args;
    var ____i45 = 0;
    while (____i45 < _35(____x279)) {
      var __x280 = ____x279[____i45];
      __s3 = __s3 + __c3 + compile(__x280);
      __c3 = ", ";
      ____i45 = ____i45 + 1;
    }
    if (args.rest) {
  ...
  var compile_special = function (form, stmt63) {
    var ____id48 = form;
    var __x281 = ____id48[0];
    var __args13 = cut(____id48, 1);
    var ____id49 = getenv(__x281);
  ...
  var op_delims = function (parent, child, ...__r178) {
    ...
    if (__e57(precedence(__child), precedence(__parent))) {
      return ["(", ")"];
    } else {
      return ["", ""];
    }
  ...
  compile_function = function (args, body, ...__r180) {
    ...
    var __args14 = destash33(args, ____r180);
    var __body29 = destash33(body, ____r180);
    ...
    var ____x284 = compile(__body29, {["_stash"]: true, ["stmt"]: true});
    indent_level = indent_level - 1;
    var __body30 = ____x284;
      ...
      if (special_form63(__form)) {
        ...
        if (atom63(__form)) {
          ...
          if (infix63(hd(__form))) {
            ...
            __e61 = compile_call(hd(__form), tl(__form));
          }
          __e60 = __e61;
        }
        var __form1 = __e60;
  ...
  var lower_do = function (args, hoist, stmt63, tail63) {
    var ____x290 = almost(args);
    var ____i47 = 0;
    while (____i47 < _35(____x290)) {
      var __x291 = ____x290[____i47];
      var ____y5 = lower(__x291, hoist, stmt63);
      if (yes(____y5)) {
        var __e31 = ____y5;
  ...
  var lower_if = function (args, hoist, stmt63, tail63) {
    ...
    if (stmt63) {
      ...
      return add(hoist, join(["%if", lower(__cond2, hoist), lower_body([__then], tail63)], __e66));
    } else {
      var __e33 = unique("e");
      add(hoist, ["%local", __e33]);
      var __e65;
      if (is63(___else)) {
        __e65 = [lower(["%set", __e33, ___else])];
      }
      add(hoist, join(["%if", lower(__cond2, hoist), lower(["%set", __e33, __then])], __e65));
      return __e33;
    }
  };
  var lower_short = function (x, args, hoist) {
    ...
    if (some63(__hoist1)) {
      ...
      var __e67;
      if (x === "and") {
        __e67 = ["%if", __id61, __b6, __id61];
      } else {
        __e67 = ["%if", __id61, __id61, __b6];
      }
      return lower(["do", ["%local", __id61, __a7], __e67], hoist);
    } else {
  ...
  var lower_while = function (args, hoist) {
    var ____id62 = args;
    var __c5 = ____id62[0];
    var __body31 = cut(____id62, 1);
    var __pre = [];
    var __c6 = lower(__c5, __pre);
    var __e68;
    if (none63(__pre)) {
      __e68 = ["while", __c6, lower_body(__body31)];
    } else {
      __e68 = ["while", true, join(["do"], __pre, [["%if", ["not", __c6], ["break"]], lower_body(__body31)])];
    }
  ...
  var lower_for = function (args, hoist) {
    ...
    var __body32 = cut(____id63, 2);
    return add(hoist, ["%for", lower(__t4, hoist), __k37, lower_body(__body32)]);
  };
  lower_table = function (args, hoist, stmt63, tail63) {
    var __expr3 = join(["%table"], keys(args));
    var ____x318 = args;
    var ____i48 = 0;
    while (____i48 < _35(____x318)) {
      var __x319 = ____x318[____i48];
      if (atom63(__x319)) {
        add(__expr3, __x319);
      } else {
        if (_35(__x319) <= 2) {
  ...
  lower_class = function (__x323, hoist, stmt63, tail63) {
    var ____id66 = __x323;
    var __x324 = ____id66[0];
    var __body34 = cut(____id66, 1);
  ...
  var lower_definition = function (kind, args, hoist) {
    ...
    var __args17 = ____id69[1];
    var __body37 = cut(____id69, 2);
  ...
  var lower_pairwise = function (form) {
    if (pairwise63(form)) {
      var __e34 = [];
      var ____id70 = form;
      var __x331 = ____id70[0];
      var __args18 = cut(____id70, 1);
      reduce(function (a, b) {
        add(__e34, [__x331, a, b]);
        return a;
      }, __args18);
  ...
  var lower_infix = function (form, hoist) {
    ...
    var __x334 = ____id71[0];
    var __args19 = cut(____id71, 1);
      ...
      if (empty63(form)) {
        ...
        if (nil63(hoist)) {
          ...
          if (lower_infix63(form)) {
            ...
            var ____id72 = form;
            var __x337 = ____id72[0];
            var __args20 = cut(____id72, 1);
            if (__x337 === "do") {
                          ...
                          if (__x337 === "%table") {
                            ...
                            if (__x337 === "%class") {
                              ...
                              if (__x337 === "%function") {
                                ...
                                if (__x337 === "%local-function" || __x337 === "%global-function") {
                                  return lower_definition(__x337, __args20, hoist);
                                } else {
                                  if (in63(__x337, ["and", "or"])) {
                                    return lower_short(__x337, __args20, hoist);
                                  } else {
                                    if (statement63(__x337)) {
  ...
  setenv("%call", {["_stash"]: true, ["special"]: function (f, ...__r213) {
    ...
    var __args21 = cut(____id73, 0);
    return compile_call(__f2, __args21);
  }});
  setenv("do", {["_stash"]: true, ["special"]: function (...forms) {
    var __forms1 = unstash(forms);
    var __s4 = "";
    var ____x339 = __forms1;
    var ____i49 = 0;
    while (____i49 < _35(____x339)) {
      var __x340 = ____x339[____i49];
      __s4 = __s4 + compile(__x340, {["_stash"]: true, ["stmt"]: true});
      if (! atom63(__x340)) {
        if (hd(__x340) === "return" || hd(__x340) === "break") {
          break;
        }
      }
      ____i49 = ____i49 + 1;
  ...
  setenv("%if", {["_stash"]: true, ["special"]: function (cond, cons, alt) {
    ...
    indent_level = indent_level + 1;
    var ____x341 = compile(cons, {["_stash"]: true, ["stmt"]: true});
    indent_level = indent_level - 1;
    var __cons = ____x341;
    var __e69;
    if (alt) {
      indent_level = indent_level + 1;
      var ____x342 = compile(alt, {["_stash"]: true, ["stmt"]: true});
      indent_level = indent_level - 1;
      __e69 = ____x342;
    }
    var __alt = __e69;
  ...
  setenv("while", {["_stash"]: true, ["special"]: function (cond, form) {
    ...
    indent_level = indent_level + 1;
    var ____x343 = compile(form, {["_stash"]: true, ["stmt"]: true});
    indent_level = indent_level - 1;
    var __body38 = ____x343;
  ...
  setenv("%for", {["_stash"]: true, ["special"]: function (t, k, form) {
    ...
    indent_level = indent_level + 1;
    var ____x344 = compile(form, {["_stash"]: true, ["stmt"]: true});
    indent_level = indent_level - 1;
    var __body39 = ____x344;
  ...
  setenv("%try", {["_stash"]: true, ["special"]: function (form) {
    ...
    indent_level = indent_level + 1;
    var ____x345 = compile(form, {["_stash"]: true, ["stmt"]: true});
    indent_level = indent_level - 1;
    var __body40 = ____x345;
    var __hf = ["return", ["%array", false, __e36]];
    indent_level = indent_level + 1;
    var ____x348 = compile(__hf, {["_stash"]: true, ["stmt"]: true});
    indent_level = indent_level - 1;
    var __h = ____x348;
    return __ind5 + "try {\n" + __body40 + __ind5 + "}\n" + __ind5 + "catch (" + __e36 + ") {\n" + __h + __ind5 + "}\n";
  }, ["stmt"]: true, ["tr"]: true});
  ...
  setenv("return", {["_stash"]: true, ["special"]: function (x) {
    ...
    var __x353 = __e70;
    return indentation() + __x353;
  }, ["stmt"]: true});
  setenv("new", {["_stash"]: true, ["special"]: function (__x354) {
    var ____id74 = __x354;
    var __name18 = ____id74[0];
    var __args22 = cut(____id74, 1);
  ...
  setenv("%array", {["_stash"]: true, ["special"]: function (...forms) {
    ...
    var __k38 = undefined;
    for (__k38 in ____o26) {
      var __v28 = ____o26[__k38];
      var __e73;
      if (numeric63(__k38)) {
  ...
  setenv("%object", {["_stash"]: true, ["special"]: function (...forms) {
    ...
    var __c8 = "";
    var __sep = ": ";
    var ____x357 = pair(__forms3);
    var ____i51 = 0;
    while (____i51 < _35(____x357)) {
      var ____id76 = ____x357[____i51];
  ...
  setenv("%table", {["_stash"]: true, ["special"]: function (...forms) {
    ...
    var ____x359 = __forms4;
    var ____i52 = 0;
    while (____i52 < _35(____x359)) {
      var __x360 = ____x359[____i52];
      if (atom63(__x360)) {
        __s8 = __s8 + __c9 + __ind7 + key(__x360) + __sep1 + compile(__x360);
      } else {
        if (_35(__x360) <= 2) {
          var ____id77 = __x360;
          ...
          var __args23 = ____id78[2];
          var __body41 = cut(____id78, 3);
          var __e74;
          if (__prefix3 === "define") {
            __e74 = "";
          } else {
          ...
          var __e75;
          if (some63(__body41)) {
            __e75 = compile_function(__args23, join(["do"], __body41), {["_stash"]: true, ["name"]: key(__name20), ["prefix"]: __prefix4});
          } else {
            __e75 = key(__name20) + __sep1 + compile(__args23);
          }
          var __h1 = __e75;
  ...
  setenv("%class", {["_stash"]: true, ["special"]: function (name, ...__r231) {
    ...
    var ____x369 = ["%table"];
    ____x369.comma = "\"\"";
    return compile(join(["%literal", "\"class \""], __name23, __ext, [join(____x369, __body42)]));
  }});
  setenv("%literal", {["_stash"]: true, ["special"]: function (...args) {
    var __args24 = unstash(args);
    var __s9 = "";
    var ____x370 = __args24;
    var ____i53 = 0;
    while (____i53 < _35(____x370)) {
      var __x371 = ____x370[____i53];
      if (string_literal63(__x371)) {
        __s9 = __s9 + _eval(__x371);
      } else {
        __s9 = __s9 + compile(__x371);
      }
      ____i53 = ____i53 + 1;
    }
    return __s9;
  ...
  setenv("%statement", {["_stash"]: true, ["special"]: function (...args) {
    ...
    var ____x372 = __args25;
    var ____i54 = 0;
    while (____i54 < _35(____x372)) {
      var __x373 = ____x372[____i54];
      if (string_literal63(__x373)) {
        __s10 = __s10 + _eval(__x373);
      } else {
        __s10 = __s10 + compile(__x373);
      }
      ____i54 = ____i54 + 1;
    }
    __s10 = __s10 + "\n";
  ...
  read_string = function (str, more) {
    var __x374 = read(stream(str, more));
    if (!( __x374 === eof)) {
      return __x374;
    }
  };
  ...
  var hex_prefix63 = function (str) {
    ...
    var __i55 = __e80;
    var __id84 = code(str, __i55) === 48;
    var __e81;
    if (__id84) {
      __i55 = __i55 + 1;
      var __n33 = code(str, __i55);
    ...
    while (nil63(__r250)) {
      ...
      if (__c14 === ")") {
        ...
        if (nil63(__c14)) {
          ...
          var __x376 = read(s);
          if (key63(__x376)) {
            var __k41 = clip(__x376, 0, edge(__x376));
            var __v31 = read(s);
            __l9[__k41] = __v31;
          } else {
            if (flag63(__x376)) {
              __l9[clip(__x376, 1)] = true;
            } else {
              add(__l9, __x376);
            }
          }
  ...
  pp_to_string = function (body) {
    if (atom63(body)) {
      ...
      if (empty63(body)) {
        ...
        var ____x378 = body;
        var ____i56 = 0;
        while (____i56 < _35(____x378)) {
          var __x379 = ____x378[____i56];
          __s111 = __s111 + str(__x379) + "\n\n";
          ____i56 = ____i56 + 1;
        }
        return __s111 + ")";
      }
  ...
  var main = function () {
    ...
    if (__arg && script_file63(__arg)) {
      ...
      if (__arg === "-h" || __arg === "--help") {
        ...
        var ____x383 = __pre1;
        var ____i58 = 0;
        while (____i58 < _35(____x383)) {
          var __file = ____x383[____i58];
          run_file(__file);
          ____i58 = ____i58 + 1;
        }
        if (nil63(__input)) {
          ...
          var __e82;
          if (__op2 === "expand") {
            __e82 = pp_to_string(expand_file(__input));
          } else {
            var __e83;
            if (__op2 === "read") {
              __e83 = pp_to_string(read_file(__input));
            } else {
              __e83 = compile_file(__input);
            }
            __e82 = __e83;
          }
          var __code2 = __e82;
